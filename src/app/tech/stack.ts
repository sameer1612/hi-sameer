export const techStack: { label: string; technologies: { name: string; imageUrl: string; url: string }[] }[] = [
  {
    ...
    technologies: [
      ...
      {
        name: 'Node.js',
        imageUrl: '/images/tech/nodejs-logo-FBE122E377-seeklogo.com.png',
        url: 'https://nodejs.org/',
      },
      {
        name: 'React',
        imageUrl: '/images/tech/react-logo-7B3CE81517-seeklogo.com.png',
  ...
  },
  {
    ...
    technologies: [
      ...
      {
        name: 'Flutter',
        imageUrl: '/images/tech/flutter-logo-5086DD11C5-seeklogo.com.png',
